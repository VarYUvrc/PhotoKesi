...
* [ ] C1: 類似判定を高速二段構成に刷新し、多様な被写体へ対応する。
    * [ ] C1-1: 96px縮小サムネから aHash／dHash／pHash を同時計算し、しきい値をチューニングする。
    * [ ] C1-2: LAB12binヒストグラムとエッジ方向ヒストグラムを加え、シーンタイプに応じて重みを切り替える。
    * [ ] C1-3: 閾値境界のグループのみ 4×4 グリッドの FAST-SSIM を実行し、スループットを計測する。
